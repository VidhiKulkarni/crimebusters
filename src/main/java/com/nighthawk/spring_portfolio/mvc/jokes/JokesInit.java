    ...
    CommandLineRunner run() {  // The run() method will be executed after the application starts
        return args -> {
            ...
            final String[] jokesArray = {
                "What are some possible reasons crimes may go unreported?" + System.lineSeparator() +"A.People are hesitant to call out of fear they will be identified by the potential criminal",
